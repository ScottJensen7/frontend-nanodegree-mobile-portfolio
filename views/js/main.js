...
var resizePizzas = function(size) {
  ...
  // Changed this function as recommended by Cameron Pittman in Lesson 5 - Stop 
  // FSL Solution.
...
function animate() {
  ...
  // Moved document.body.scrollTop out of the loop and stored it in a variable called scrollTop.
  var scrollTop = document.body.scrollTop;
  for (var i = 0; i < items.length; i++) {
    // Using scrollTop variable in the next line greatly improves speed.
...
// I made this function called updatePositions. It improves speed by calling requestAnimationFrame.
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // Instead of looping the fixed count of 200, loop until you reach the edge
  // of the screen on both the right side and the bottom.
  for (var i = 0; i < 200; i++) {
    ...
    if (elem.basicLeft > window.innerWidth) {
      while (i % cols !== 0) {
        i++;
      }
    }
